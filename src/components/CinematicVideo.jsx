...
const beats = [
  ...
  { text: 'Backend Development',              progress: [0.62, 0.74], size: 'md', theme: 'neon-green' },
  { text: 'Artificial Intelligence',          progress: [0.74, 0.84], size: 'md', theme: 'neon-magenta' },
  { text: 'For The Future',                   progress: [0.84, 0.92], size: 'lg', theme: 'neon-holo' },
  {
